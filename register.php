...
<a href="Home" aria-current="page" class="nav-link w-nav-link w--current">
HOME</a>
...
<a href="/members-area" class="nav-link-7 w-nav-link">
MEMBERS AREA
</a>
<a href="login.htm" class="nav-link-8 w-nav-link">
CALCULATOR
</a>
</nav>
    ...
    <div class="container">
		...
		<div class="card" >
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">>
						...
						<input type="text" class="input-box" placeholder="Your email"  name="email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>">
                <span class="invalid-feedback"><?php echo $email_err; ?>
				<input type="password" class="input-box" name="password" placeholder="Your password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>">
                <span class="invalid-feedback"><?php echo $password_err; ?></span>
                <input type="password" class="input-box" name="confirm_password" placeholder="Your password again" class="form-control <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>">
